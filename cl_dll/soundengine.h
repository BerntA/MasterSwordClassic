...
private:
	...
	(FMOD_SYSTEM **system);
	FMOD_RESULT(_stdcall *_FMOD_System_GetVersion)
	(FMOD_SYSTEM *system, unsigned int *version);
	FMOD_RESULT(_stdcall *_FMOD_System_GetNumDrivers)
	(FMOD_SYSTEM *system, int *numdrivers);
	FMOD_RESULT(_stdcall *_FMOD_System_SetOutput)
	(FMOD_SYSTEM *system, FMOD_OUTPUTTYPE output);
	FMOD_RESULT(_stdcall *_FMOD_System_GetDriverCaps)
	(FMOD_SYSTEM *system, int id, FMOD_CAPS *caps, int *minfrequency, int *maxfrequency, FMOD_SPEAKERMODE *controlpanelspeakermode);
	FMOD_RESULT(_stdcall *_FMOD_System_SetSpeakerMode)
	(FMOD_SYSTEM *system, FMOD_SPEAKERMODE speakermode);
	FMOD_RESULT(_stdcall *_FMOD_System_SetDSPBufferSize)
	(FMOD_SYSTEM *system, unsigned int bufferlength, int numbuffers);
	FMOD_RESULT(_stdcall *_FMOD_System_GetDriverInfo)
	(FMOD_SYSTEM *system, int id, char *name, int namelen, FMOD_GUID *guid);
	FMOD_RESULT(_stdcall *_FMOD_System_SetSoftwareFormat)
	...
	FMOD_RESULT(_stdcall *_FMOD_System_Init)
	(FMOD_SYSTEM *system, int maxchannels, FMOD_INITFLAGS flags, void *extradriverdata);
	FMOD_RESULT(_stdcall *_FMOD_System_Set3DSettings)
	(FMOD_SYSTEM *system, float dopplerscale, float distancefactor, float rolloffscale);
	FMOD_RESULT(_stdcall *_FMOD_System_Release)
	(FMOD_SYSTEM *system);
	FMOD_RESULT(_stdcall *_FMOD_Channel_Stop)
	(FMOD_CHANNEL *channel);
	FMOD_RESULT(_stdcall *_FMOD_Sound_Release)
	(FMOD_SOUND *sound);
	FMOD_RESULT(_stdcall *_FMOD_System_SetReverbAmbientProperties)
	(FMOD_SYSTEM *system, FMOD_REVERB_PROPERTIES *prop);
	FMOD_RESULT(_stdcall *_FMOD_Channel_SetPaused)
	(FMOD_CHANNEL *channel, FMOD_BOOL paused);
	FMOD_RESULT(_stdcall *_FMOD_System_Update)
	(FMOD_SYSTEM *system);
	FMOD_RESULT(_stdcall *_FMOD_System_Set3DListenerAttributes)
	...
	FMOD_RESULT(_stdcall *_FMOD_Channel_IsPlaying)
	(FMOD_CHANNEL *channel, FMOD_BOOL *isplaying);
	FMOD_RESULT(_stdcall *_FMOD_Channel_GetPaused)
	(FMOD_CHANNEL *channel, FMOD_BOOL *paused);
	FMOD_RESULT(_stdcall *_FMOD_Channel_Set3DAttributes)
	(FMOD_CHANNEL *channel, const FMOD_VECTOR *pos, const FMOD_VECTOR *vel);
	FMOD_RESULT(_stdcall *_FMOD_Channel_GetPosition)
	(FMOD_CHANNEL *channel, unsigned int *position, FMOD_TIMEUNIT postype);

	FMOD_RESULT(_stdcall *_FMOD_Channel_SetVolume)
	(FMOD_CHANNEL *channel, float volume);
	FMOD_RESULT(_stdcall *_FMOD_Channel_SetFrequency)
	(FMOD_CHANNEL *channel, float frequency);
	FMOD_RESULT(_stdcall *_FMOD_Channel_GetFrequency)
	(FMOD_CHANNEL *channel, float *frequency);
	FMOD_RESULT(_stdcall *_FMOD_System_CreateSound)
	(FMOD_SYSTEM *system, const char *name_or_data, FMOD_MODE mode, FMOD_CREATESOUNDEXINFO *exinfo, FMOD_SOUND **sound);
	FMOD_RESULT(_stdcall *_FMOD_System_PlaySound)
	(FMOD_SYSTEM *system, FMOD_CHANNELINDEX channelid, FMOD_SOUND *sound, FMOD_BOOL paused, FMOD_CHANNEL **channel);
	FMOD_RESULT(_stdcall *_FMOD_Channel_Set3DMinMaxDistance)
	(FMOD_CHANNEL *channel, float mindistance, float maxdistance);
	FMOD_RESULT(_stdcall *_FMOD_System_CreateStream)
	(FMOD_SYSTEM *system, const char *name_or_data, FMOD_MODE mode, FMOD_CREATESOUNDEXINFO *exinfo, FMOD_SOUND **sound);
	FMOD_RESULT(_stdcall *_FMOD_Channel_SetDelay)
	(FMOD_CHANNEL *channel, FMOD_DELAYTYPE delaytype, unsigned int delayhi, unsigned int delaylo);
	FMOD_RESULT(_stdcall *_FMOD_Channel_SetPosition)
	(FMOD_CHANNEL *channel, unsigned int position, FMOD_TIMEUNIT postype);
	FMOD_RESULT(_stdcall *_FMOD_Sound_GetFormat)
