...
enum stage_e { STG_FIRST, STG_CHOOSECHAR = STG_FIRST, STG_CHOOSEGENDER, STG_CHOOSERACE, STG_CHOOSEWEAPON, STG_LAST = STG_CHOOSEWEAPON };
...
public:
	...
	void UnRegister( )
	{ 
		m_Done = true; CRenderEntity::UnRegister();
	}
	...
	enum rendercharstate_e { RCS_IDLE, RCS_FIDGET, RCS_HIGHLIGHT, RCS_INACTIVE } m_AnimState;
};
