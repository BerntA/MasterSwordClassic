...
#define MODEL_HUMAN_Z_ADJ	0								// MIB FEB2015_21 [RACE_MENU] - Z origin adjustment for char/race selection
#define MODEL_DWARF_Z_ADJ	0								// Dwarf/Elf should probably be -.5 
#define MODEL_ELF_Z_ADJ		0								// But anything between -1 and 0 doesn't do anything
