...
*/
class CFuncWall : public CScriptedEnt
{
public:
	void Spawn(void);
...
public:
	...
	float conveyor_original_speed; //Thothie AUG2011_30 toggle conveyors
};
...
void CFuncConveyor ::Spawn(void)
{
	...
	conveyor_original_speed = pev->speed;

	if (pev->spawnflags & SF_CONVEYOR_TOGGLE)
	{
		//Thothie SEP2011_02 - Toggle'able conveyors start off
		UpdateSpeed(0);
		pev->speed = 0;
	}
	else
...
{
	//Thothie AUG2011_30 - Make conveyors toggle'able
	if (pev->spawnflags & SF_CONVEYOR_TOGGLE)
	{
		if (pev->speed != 0)
		{
		...
		{
			pev->speed = conveyor_original_speed;
		}
	}
	else
	{
...
// =================== FUNC_ROTATING ==============================================
class CFuncRotating : public CScriptedEnt
{
public:
	typedef CScriptedEnt BaseClass;
...
void CFuncRotating ::Rotate(void)
{
	...
	pev->nextthink = BaseThinkTime() + 0.001f;
}
...
class CPendulum : public CScriptedEnt
{
public:
	void Spawn(void);
	void KeyValue(KeyValueData *pkvd);
