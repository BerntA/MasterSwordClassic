...
#define bits_SOUND_WALKING (1 << 7) // MasterSword: Just walking/moving
...
public:
	...
	//Master Sword
	//char	m_Race[64];		//The race that caused this sound (So allied races don't turn to constantly check on each other)
	entityinfo_t m_SrcEntity; // The one that make the sound
	msstring m_Type;		  // Sound type (string)
	float m_DangerRadius;	  // Danger radius for danger types
	//------------
...
public:
	...
	float m_TimeLastThink;

	static CSoundEnt m_gSoundEnt; //Global sound control entity
