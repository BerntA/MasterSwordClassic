...
void CBaseAnimating ::DispatchAnimEvents(float flInterval)
{
	...
	if (!pmodel)
	{
		//Thothie - This message is as common as it is useless
		//- seems to be caused all the time for no known reason
...
{
	//Thothie - was without return - wonderin if related to armor issue
	return ::SetBodygroup(GET_MODEL_PTR(ENT(pev)), pev, iGroup, iValue);
}
