...
{ 
	...
	if ( IsTriggered( pActivator ) )
	{
		...
		pev->iuser1 = m_iTotal; //NOV2014_12 Thothie - trying to manage masters with ms ents
	...
	{
		pev->iuser1 = 0; //NOV2014_12 Thothie - trying to manage masters with ms ents
	}
}
...
{ 
	...
	switch ( sound )
	{
		case 0: pszSound = "null.wav";        break; //Thothie MAR2012_26 - cutting down on sound precaches
