...
int UTIL_NumActivePlayers()
{
	...
	if (total_valid_players <= 0 && flagged_invalid)
		total_valid_players = 1; //in case we flagged all the players invalid, dun wanna screw with mob spawns/chests
	else if (total_valid_players < 0)
		total_valid_players = 1; //redundancy, not sure how this wouldhappen
	return total_valid_players;
}
...
float UTIL_TotalHP()
{
	...
	if (total_hp <= 0 && flagged_invalid)
		total_hp = 1; //in case we flagged all the players invalid, dun wanna screw with mob spawns/chests
	else if (total_valid_players < 0)
		total_hp = 1; //redundancy, not sure how this wouldhappen
	return total_hp;
}
...
float UTIL_AvgHP()
{
	...
	if (out <= 0 && flagged_invalid)
		...
		out = 1; //redundancy, not sure how this wouldhappen
	return out;
}
