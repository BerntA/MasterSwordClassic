...
static short g_sModelIndexFireball;
static short g_sModelIndexSmoke;
...
void CShower::Spawn(void)
{
	...
	SET_MODEL(edict(), "models/null.mdl"); // Need a model, just use the grenade, we don't draw it anyway
...
{
	g_sModelIndexFireball = PRECACHE_MODEL("sprites/fireball1.spr"); // fireball sprite
...
void ExplosionCreate(const Vector &center, const Vector &angles, edict_t *pOwner, int magnitude, BOOL doDamage)
{
	...
	CBaseEntity *pExplosion = CBaseEntity::Create("env_explosion", center, angles, pOwner);
	 _snprintf(buf, sizeof(buf),  "%3d",  magnitude );
