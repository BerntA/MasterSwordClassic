...
void READ_REWIND_LONG( void ) { giRead -= 4; }
void READ_REWIND_CHAR( void ) { giRead -= 1; }
void READ_REWIND_SHORT( void ) { giRead -= 2; }
void READ_REWIND_COORD( void ) { READ_REWIND_SHORT(); }
