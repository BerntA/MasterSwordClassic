...
typedef struct playermove_s
{
	...
	//Dogg: Note - How PM_Sound works:
	//		On the client it plays for the client running player move
	//		On the server it plays for everyone EXCEPT the player currently running player move
